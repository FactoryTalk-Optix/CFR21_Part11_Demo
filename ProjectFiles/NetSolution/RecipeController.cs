...
public class RecipeController : BaseNetLogic
{
        ...
        try
        {
            ...
            if (store != null && editModel != null)
            {
                if (RecipeExistsInStore(store, schema, name))
                {
                    ...
                    LogIntoAudit("Recipe Saved", name, "RecipeApplicationEvent");
                }
                else
                {
                    // Create recipe
    ...
    public void Delete(string RecipeName)
    {
        ...
        try
        {
            ...
            LogIntoAudit("Recipe Deleted", name, "RecipeApplicationEvent");
        }
        catch (Exception e)
        {
            SetFeedback(2, e.Message);
    ...
    [ExportMethod]
    public void LoadFromPLC(string RecipeName, CopyErrorPolicy ErrorPolicy)
    {
        if (LoadFromPLCTrigger != null)
        ...
        try
        {
            ...
            if (editModel != null)
            {
                ...
                LogIntoAudit("Recipe Loaded", RecipeName, "RecipeApplicationEvent");
            }
        }
        catch (Exception e)
        {
    ...
    [ExportMethod]
    public void ApplyFromEditModel(string RecipeName, CopyErrorPolicy ErrorPolicy)
    {
        if (ApplyFromEditModelTrigger != null)
    ...
    public void Export()
    {
        ...
        try
        {
            ...
            LogIntoAudit("Recipe Exported", csvPath, "RecipeApplicationEvent");
        }
        catch (Exception e)
        {
    ...
    public void Import()
    {
        ...
        try
        {
            using (var csvReader = new CSVFileReader(csvPath) { FieldDelimiter = separator, IgnoreMalformedLines = true, WrapFields = wrapFields })
            {
                ...
                LogIntoAudit("Recipe Imported", csvPath, "RecipeApplicationEvent");
            }
        }
        catch (Exception e)
        {
